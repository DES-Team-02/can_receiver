...
*/
#ifndef V0_COMMONAPI_Can_Receiver_STUB_DEFAULT_HPP_
#define V0_COMMONAPI_Can_Receiver_STUB_DEFAULT_HPP_
...
/**
 * Provides a default implementation for CanReceiverStubRemoteEvent and
 * CanReceiverStub. Method callbacks have an empty implementation,
 ...
 * behaviour.
 */
class COMMONAPI_EXPORT_CLASS_EXPLICIT CanReceiverStubDefault
    : public virtual CanReceiverStub {
public:
    COMMONAPI_EXPORT CanReceiverStubDefault()
        : remoteEventHandler_(this),
          interfaceVersion_(CanReceiver::getInterfaceVersion()) {
    }
    ...
    COMMONAPI_EXPORT CanReceiverStubRemoteEvent* initStubAdapter(const std::shared_ptr< CanReceiverStubAdapter> &_adapter) {
        CommonAPI::Stub<CanReceiverStubAdapter, CanReceiverStubRemoteEvent>::stubAdapter_ = _adapter;
        return &remoteEventHandler_;
    }

    COMMONAPI_EXPORT virtual const ::v0::commonapi::CanReceiver::SonarArrayStruct &getDistancesAttribute() {
        return distancesAttributeValue_;
    }
    COMMONAPI_EXPORT virtual const ::v0::commonapi::CanReceiver::SonarArrayStruct &getDistancesAttribute(const std::shared_ptr<CommonAPI::ClientId> _client) {
        (void)_client;
        return getDistancesAttribute();
    }
    COMMONAPI_EXPORT virtual void setDistancesAttribute(::v0::commonapi::CanReceiver::SonarArrayStruct _value) {
...
protected:
    COMMONAPI_EXPORT virtual bool trySetDistancesAttribute(::v0::commonapi::CanReceiver::SonarArrayStruct _value) {
        if (!validateDistancesAttributeRequestedValue(_value))
            return false;

        bool valueChanged;
        std::shared_ptr<CanReceiverStubAdapter> stubAdapter = CommonAPI::Stub<CanReceiverStubAdapter, CanReceiverStubRemoteEvent>::stubAdapter_.lock();
        if(stubAdapter) {
    ...
    COMMONAPI_EXPORT virtual bool validateDistancesAttributeRequestedValue(const ::v0::commonapi::CanReceiver::SonarArrayStruct &_value) {
        (void)_value;
        return true;
    }
    ...
    class COMMONAPI_EXPORT_CLASS_EXPLICIT RemoteEventHandler: public virtual CanReceiverStubRemoteEvent {
    public:
        COMMONAPI_EXPORT RemoteEventHandler(CanReceiverStubDefault *_defaultStub)
            : 
    ...
    private:
        CanReceiverStubDefault *defaultStub_;
    };
protected:
    CanReceiverStubDefault::RemoteEventHandler remoteEventHandler_;

private:

    ::v0::commonapi::CanReceiver::SonarArrayStruct distancesAttributeValue_ {};
...
#endif // V0_COMMONAPI_Can_Receiver_STUB_DEFAULT
