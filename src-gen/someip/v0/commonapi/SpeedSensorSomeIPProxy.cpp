...
SpeedSensorSomeIPProxy::SpeedSensorSomeIPProxy(
    ...
    const std::shared_ptr<CommonAPI::SomeIP::ProxyConnection> &_connection)
        : CommonAPI::SomeIP::Proxy(_address, _connection),
          speed_(*this, UNDEFINED_EVENTGROUP_ID, UNDEFINED_NOTIFIER_ID, CommonAPI::SomeIP::method_id_t(0x0), false, CommonAPI::SomeIP::reliability_type_e::RT_UNRELIABLE, false, static_cast< CommonAPI::SomeIP::IntegerDeployment<uint32_t>* >(nullptr)),
          rpm_(*this, UNDEFINED_EVENTGROUP_ID, UNDEFINED_NOTIFIER_ID, CommonAPI::SomeIP::method_id_t(0x0), false, CommonAPI::SomeIP::reliability_type_e::RT_UNRELIABLE, false, static_cast< CommonAPI::SomeIP::IntegerDeployment<uint32_t>* >(nullptr))
{
}
